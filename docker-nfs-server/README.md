...
docker run -v /mnt/jenkins:/var/jenkins_home -e NFS_EXPORT_0='/var/jenkins_home  *(rw,async,no_subtree_check,no_root_squash)' --cap-add SYS_ADMIN -p 2049:2049 erichough/nfs-server
